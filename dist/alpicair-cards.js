        ...
        ${this._config.show_dial?c`
            <div class="dial-wrap">
              <svg viewBox="0 0 200 200">
                ${rt`<path d=${te(ht,ht+Xt)} fill="none" stroke="var(--secondary-background-color)" stroke-width="9" stroke-linecap="round" />`}
                ${i?rt`<path d=${te(ht,p)} fill="none" stroke="var(--primary-color)" stroke-width="9" stroke-linecap="round" />`:r}
                ${rt`<circle cx=${g.x} cy=${g.y} r="13" fill="var(--card-background-color)" stroke=${i?"var(--primary-color)":"var(--disabled-text-color)"} stroke-width="3" />`}
              </svg>
